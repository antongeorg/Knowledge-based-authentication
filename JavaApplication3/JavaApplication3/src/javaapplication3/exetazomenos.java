...
public class exetazomenos extends javax.swing.JFrame {

    /**
     * Creates new form exetazomenos
     */
    public exetazomenos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField10.setText("Όνομα");

        jTextField11.setText("Επίθετο");

        jTextField12.setText("Κωδικός εξεταστικού κέντρου");

        jTextField13.setText("Κωδικός εξέτασης");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            kentro = Integer.parseInt(jTextField6.getText());
            exetasi = Integer.parseInt(jTextField7.getText());
        } catch (NumberFormatException numberFormatException) {
        }
         foo2(user,pass,name,lname,kentro,exetasi);
    if(showCount()>=1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(exetazomenos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private static void foo2(java.lang.String arg0, java.lang.String arg1, java.lang.String arg2, java.lang.String arg3, int arg4, int arg5) {
        java1.Ipopsifiows_Service service = new java1.Ipopsifiows_Service();
        java1.Ipopsifiows port = service.getIpopsifiowsPort();
